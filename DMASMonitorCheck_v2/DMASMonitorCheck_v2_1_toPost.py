...
DMAS Monitor Check - Version 2.1
...
#       My work around is to have the .bat file run in an infinite loop in the background of my computer
...
import cartopy.crs as ccrs #    I know this is imported twice but it avoids errors for some reason when imported the second time ¯\_(ツ)_/¯
...
creds = Credentials(username = '[YourUserName]',password = '[YourPassword]')
a = Account(primary_smtp_address='[YourEmail]',credentials=creds,autodiscover = True, access_type = DELEGATE) 
